...
exports.userSwaggerDocs = void 0;
exports.userSwaggerDocs = {
    "/api/user/update-profile": {
        patch: {
            tags: ["User"],
            summary: "Update user profile",
            description: "Updates the authenticated user's profile information, including optional profile image upload. Accessible by both ADMIN and USER roles.",
            security: [{ bearerAuth: [] }],
            requestBody: {
                required: true,
                content: {
                    "multipart/form-data": {
                        schema: {
                            ...
                            properties: {
                                ...
                                data: {
                                    type: "string",
                                    description: "JSON string containing user profile update data (validated by `user_validations.update_user`)",
